...
@Component({
  selector:'app-pdf-free-renta',
  templateUrl:'./pdf-free-renta.component.html',
  styleUrls:['./pdf-free-renta.component.css']
})
export class PdfFreeRentaComponent{ 
  resume = new Resume();
  degrees = ['Free99 Renta'];
  constructor() {
