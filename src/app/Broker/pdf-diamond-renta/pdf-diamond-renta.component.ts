...
@Component({
  selector: 'app-pdf-diamond-renta',
  templateUrl:'./pdf-diamond-renta.component.html',
  styleUrls: ['./pdf-diamond-renta.component.css']
})
export class PdfDiamondRentaComponent{ 
  resume = new Resume();
  degrees = ['Diamond99 Renta'];
  constructor() {
