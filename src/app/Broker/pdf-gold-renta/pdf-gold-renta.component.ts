...
@Component({
  selector: 'app-pdf-gold-renta',
  templateUrl:'./pdf-gold-renta.component.html',
  styleUrls: ['./pdf-gold-renta.component.css']
})
export class PdfGoldRentaComponent{ 
  resume = new Resume();
  degrees = ['Gold99 Renta'];
  constructor() {
