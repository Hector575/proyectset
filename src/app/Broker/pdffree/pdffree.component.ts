...
@Component({
  selector: 'app-root',
  templateUrl: './pdffree.component.html',
  styleUrls: ['./pdffree.component.css']
})
export class PdffreeComponent {
  resume = new Resume();
  degrees = ['Broker99 Renta'];
  constructor() {
